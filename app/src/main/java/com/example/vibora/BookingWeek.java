...
public class BookingWeek extends AppCompatActivity implements CalendarAdapter.OnItemListener, BookingAdapter.OnTimeSlotClickListener{
    ...
    private void initViews() {
        ...
        field_name_text.setText("Booking " + FIELD_NAME);
    ...
    public void onTimeSlotClick(TimeSlotModel timeSlot) {
        ...
        intent.putExtra("RESERVED_SPOTS", timeSlot.getReserved_spots());
